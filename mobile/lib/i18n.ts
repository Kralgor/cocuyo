...
const STRINGS: StringMap = {
  ...
  when_label:           { es: '¿Cuándo pasó?',                                    en: 'When did it happen?' },
  when_now:             { es: 'Ahora mismo',                                      en: 'Right now' },
  when_earlier:         { es: 'Antes',                                            en: 'Earlier' },
  when_today:           { es: 'Hoy',                                              en: 'Today' },
  when_yesterday:       { es: 'Ayer',                                             en: 'Yesterday' },
  when_start:           { es: 'Empezó',                                           en: 'Started' },
  when_end:             { es: 'Volvió',                                           en: 'Came back' },
  when_ongoing:         { es: 'Sigue sin luz',                                    en: 'Still no power' },
